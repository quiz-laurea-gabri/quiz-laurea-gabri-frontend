                ...
                <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
                    ...
                    <ListboxOptions
                        ...
                        <ListboxOption as="template" v-for="category in categories" :key="category.id"
                            :value="category.name" v-slot="{ active, selectedCategory }">
                            <li :class="[
        ...
        <Listbox as="div" v-model="selectedDifficulty">
            ...
            <div class="mt-1 relative">
                ...
                <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
                    ...
                    <ListboxOptions
                        class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-56 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                        <ListboxOption as="template" v-for="difficulty in difficulties" :key="difficulty"
                            :value="difficulty" v-slot="{ active, selectedDifficulty }">
                            <li :class="[
                              active ? 'text-white bg-purple-600' : 'text-gray-900',
                              'cursor-default select-none relative py-2 pl-3 pr-9',
                            ]">
